...
<script setup lang="ts" name="ServiceOrderLineChart">
import { onMounted, ref } from "vue";
import { getHomeServiceOrderStatistics } from "@/api/modules/home";
...
const getData = () => {
	...
	getHomeServiceOrderStatistics(param).then((res: any) => {
